...
function createProjectsSheet() {
  ...
  const rows = [
    [
      ...
      '2026-05-22',
      '応援者グループ形成まであと18人',
      '防災をもっと身近に広げるため、起案者の背景を読み、金額・人数・商品化の方向性を一緒に決める募集です。',
      'owner-detail.html#supporter-plan',
      'TRUE'
    ],
    [
      'revoart',
...
function defaultMemo_(key) {
  const memos = {
    ...
    remainingSupporters: '応援者グループ形成までの残り人数',
    hopeAmount: '希望金額',
    usedAmount: '利用金額',
    operatingAmount: '運用額',
    remainingBudget: '残',
